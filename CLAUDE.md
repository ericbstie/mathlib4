...
**R2 — Docstring dependency claims are not trustworthy; re-derive the graph.**
...
**R6 — Subagents are for reconnaissance; keep proving and integrating in the main session.**
...
* Prefer `have` over `haveI` for propositions — there is a style linter for it.
